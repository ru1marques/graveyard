...
var ProtectedListPage = (0, import_react.lazy)(() => import("./settings-W6IAL4K7.js").then((mod) => ({
  default: mod.ProtectedListPage
})));
var ProtectedEditPage = (0, import_react.lazy)(() => import("./id-IF75C4BD.js").then((mod) => ({
...
//# sourceMappingURL=router-AIRQNXRO.js.map
